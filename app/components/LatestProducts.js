...
import { getNewProduct } from "@/app/components/services/ServerConnection";
...
const LatestProducts = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data: dataSlider } = await getNewProduct();
    ...
    return (
        <Swiper
            ...
            className="rounded-3 mt-4 shadow bg-light user-select-none" style={{ height: '320px' }}
        >
            <SwiperSlide>
                <div className="col shadow-sm rounded-0 rounded-start-4 bg-light d-flex align-items-center text-center"
                    ...
                    <div className="card-body">
                        ...
                        >
                            <span className="fs-6 me-2 fw-bold">مشاهده همه</span>
